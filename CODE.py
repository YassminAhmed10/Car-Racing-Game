...
#sound
pygame.mixer.init()
sound1 = pygame.mixer.Sound('C:\\Users\\LOQ\\Downloads\\Car Racing Game\\Car Racing Game\\img\\music\\m1.mp3')
sound1.play()
...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg = pygame.image.load('Car Racing Game/img/1.png')
        self.car_x_coordinate = (self.display_width * 0.45)
        self.car_y_coordinate = (self.display_height * 0.8)
        self.car_width = 49

        # enemy_car
        self.enemy_car = pygame.image.load('Car Racing Game/img/5.png')
        ...
        # Background
        self.bgImg = pygame.image.load("Car Racing Game/img/back_ground.jpg")
